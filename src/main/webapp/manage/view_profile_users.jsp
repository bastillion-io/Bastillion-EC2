...
<head>
    ...
    <title>EC2Box - Assign Users to Profile</title>
        ...
        <s:if test="sortedSet.itemList!= null && !sortedSet.itemList.isEmpty()">
           ...
           <div class="scrollWrapper">
                <table class="table-striped scrollableTable">
                    ...
                    <tr>
                        <th id="<s:property value="@com.ec2box.manage.db.UserDB@PROFILE_ID"/>" class="sort"><s:checkbox name="userSelectAll" cssClass="userSelect" theme="simple"/></th>
            ...
            <div id="assign_users" class="btn btn-primary assign_user_btn spacer spacer-bottom">Assign</div>
        </s:if>
        <s:else>
