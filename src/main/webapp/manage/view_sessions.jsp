            ...
            <h3>Audit Sessions</h3>
                ...
                <table class="table-striped scrollableTable">
                    ...
                    <tr>
                        ...
                        <th id="<s:property value="@com.ec2box.manage.db.SessionAuditDB@SORT_BY_USERNAME"/>" class="sort">Username</th>

                        <th id="<s:property value="@com.ec2box.manage.db.SessionAuditDB@SORT_BY_LAST_NM"/>" class="sort">Last Name</th>
                        <th id="<s:property value="@com.ec2box.manage.db.SessionAuditDB@SORT_BY_FIRST_NM"/>" class="sort">First Name</th>
                        <th id="<s:property value="@com.ec2box.manage.db.SessionAuditDB@SORT_BY_SESSION_TM"/>" class="sort">Session Time</th>
                        <th>&nbsp;</th>
