...
We need to know your email address and GitHub id so that we can contact you about your entry. Your information will only be used to administer the Netflix Cloud Prize itself. We are collecting information using this MailChimp[http://eepurl.com/wJbIT] form. It will send you an email to verify your address. There are currently problems with gmail accounts, that are being worked on.
