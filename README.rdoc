...
We want you to build something cool using or modifying our open source software.  You submission will be a patch for one of our open source projects or a standalone program.  Your submission will be judged in these categories:
...
If you win, you'll get US$10,000 cash, US$5000 AWS credits, a trip to Las Vegas for two, and fame and notoriety (at least within Netflix Engineering).
